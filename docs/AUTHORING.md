...
The script and the series config describe **the film**, not a model. Each shot renders on a
**video target** (a model plus its ComfyUI workflow): MiniMax H3 Ref2VA unless the series
